...
class GCSService(BaseCloudObjectStorageService):
    def __init__(self, project_name: str, region: str, service_account_credentials: Dict[str, str]) -> None:
    ...
    def save_from_memory_to_object_storage(self,
        data: bytes,
        project_name: str,
        bucket_name: str,
        **kwargs,
    ...
    def copy_to_internal_object_storage(self,
    ...
    def delete_from_internal_object_storage(self,
...
# probably I do not need external methods as I could just use other cloud module maybe for smaller clouds not covered with interfaces
    def copy_to_external_object_storage(self,         files_to_move: List[str],
        source_project_name: str,
        source_bucket_name: str,
